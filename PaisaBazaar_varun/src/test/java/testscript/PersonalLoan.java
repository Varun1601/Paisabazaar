...
String Str1,browser,AgentId,URL,LoanAmount,EmploymentType,MonthlyIncome,Residence,EmailAddress,MobileNumber,LoanPurpose,EmployerName,BankAccount,CurrentEMI,FullName,Date,Month,Year;
String path = "C:\\Users\\Varun\\workspace\\PaisaBazaar_varun\\target\\classes\\config\\config.properties";
...
public void testcase1() throws InterruptedException{
	...
	data = Excel.ReadTestCaseData(oProperty.getProperty("PaisaBazaar"),oProperty.getProperty("Sheet1"));
	System.out.println("hello");
	browser = data.get("TC_001").get("browser");
	System.out.println(browser);
	URL = data.get("TC_001").get("URL");
...
//	oBrowser.clickElement(By.xpath("//a[@href='/personal-loan/'][1]"));
	...
	LoanAmount = data.get("TC_001").get("LoanAmount");
	EmploymentType = data.get("TC_001").get("EmploymentType");
	MonthlyIncome = data.get("TC_001").get("MonthlyIncome");
	Residence = data.get("TC_001").get("Residence");
	EmailAddress = data.get("TC_001").get("EmailAddress");
	MobileNumber = data.get("TC_001").get("MobileNumber");
	EmployerName = data.get("TC_001").get("EmployerName");
	BankAccount = data.get("TC_001").get("BankAccount");
	CurrentEMI = data.get("TC_001").get("CurrentEMI");
	FullName = data.get("TC_001").get("FullName");
	Date = data.get("TC_001").get("Date").trim();
	Month = data.get("TC_001").get("Month");
	Year = data.get("TC_001").get("Year");
	AgentId = data.get("TC_001").get("AgentId");
...
//	oBrowser.clickElement(By.xpath("(//div[@class='radio radio-info radio-inline'])[1]"));
	
	oBrowser.clickElement(By.id("view-best-offers"));
    
//	oBrowser.clickElement(By.xpath(xpathExpression));
...
//	String getUrl = oBrowser.getCurrentUrl();
...
//	Excel.openExcelWorkbook(oProperty.getProperty("PaisaBazaar"));
	...
	String Sheet1 = oProperty.getProperty("Sheet1");
	System.out.println(Sheet1);
	String PaisaBazaar = oProperty.getProperty("PaisaBazaar");
	System.out.println(PaisaBazaar);
	oBrowser.ChildQuoteSize6();
	oBrowser.Ullitabledata1("//ul[contains(@class, 'ul-loop')]//button[text() = 'Apply']", "//ul[contains(@class, 'ul-loop')]//button[text() = 'Enquire']", Sheet1, PaisaBazaar, Excel, 2);	
